...
function updateTimer() {
  const targetDate = new Date("january 3, 2025 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543814048725'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543814048725'; // Número para el primer botón
  const recipientNumber2 = '543813273738'; // Número para el segundo botón
